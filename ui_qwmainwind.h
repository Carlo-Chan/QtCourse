...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        actOpen->setMenuRole(QAction::MenuRole::TextHeuristicRole);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/images/info.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actAbout->setIcon(icon11);
        actAbout->setMenuRole(QAction::MenuRole::AboutRole);
